...
with st.sidebar:
    ...
    st.title("LipNet - Mapping Visual Cues to Spoken Language ")
    st.info(
        "Hi 👋 , I analyze and decipher lip movements captured in video sequences, subsequently translating them into corresponding textual representations."
    )
